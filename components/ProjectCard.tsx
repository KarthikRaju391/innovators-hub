...
function ProjectCard({ project, featured = false, currentUserId }: ProjectCardProps) {
              ...
              <div className="flex items-center gap-2 text-sm text-gray-500">
                ...
                {!isCreator && (
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-md bg-indigo-50 text-indigo-600 border border-indigo-200 hover:bg-indigo-100 hover:border-indigo-300 transition-colors font-medium"
                  >
